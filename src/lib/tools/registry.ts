...
export const TOOLS: Tool[] = [
  ...
  {
    id: "row-agg",
    name: "รวมหลายคอลัมน์ต่อแถว",
    desc: "สรุปหลายคอลัมน์ในแถวเดียว → เติมคอลัมน์ผลลัพธ์ท้ายตาราง เช่น น้ำหนักแยกหลายวัน/หลายเจ้า (เจ้าละคอลัมน์) → ยอดรวมต่อแถว · เลือกได้ ผลรวม / เฉลี่ย / มากสุด / น้อยสุด / พิสัย / นับช่อง · ต่างจากคอลัมน์คำนวณ (แค่ 2 ค่า) และสรุปกลุ่ม (สรุปลงคอลัมน์) — อันนี้สรุปข้ามคอลัมน์ในแถวเดียว · ช่องไม่ใช่ตัวเลข = ข้ามไป ไม่นับ · อ่านอย่างเดียว ไม่แก้ข้อมูลเดิม",
    icon: "➕",
    category: "excel",
    href: "/row-agg",
    status: "ready",
  ...
  {
    id: "unit-col",
    name: "รวมหน่วยในคอลัมน์",
    desc: "แปลงทั้งคอลัมน์ให้เป็นหน่วยเดียวกัน — ค่าปนหน่วย เช่น \"10 kg\" / \"5,000 g\" / \"1.5 ton\" → เป็น kg หมด (น้ำหนัก/ความยาว/ปริมาตร) · อ่านหน่วยจากในช่องเอง (kg, g, ตัน, ลิตร, cm, นิ้ว...) · ต่างจากเครื่องแปลงหน่วยที่กรอกทีละค่า — อันนี้ทำทั้งไฟล์ · ช่องไม่มีหน่วย = ข้าม (หรือกำหนดเองว่าให้ถือเป็นหน่วยไหน) ไม่เดามั่ว · หน่วยผิดหมวด/อ่านไม่ออก = เว้นว่าง โชว์ให้เห็น · เติมคอลัมน์ใหม่ (ไม่ทับของเดิม) · ทุกแถวออกครบ",
    icon: "⚖️",
    category: "logistics",
    href: "/unit-col",
    status: "ready",
    keywords: ["รวมหน่วย", "แปลงหน่วย", "unit", "หน่วย", "normalize unit", "unit conversion", "convert column", "kg", "กิโล", "กรัม", "gram", "ตัน", "ton", "ปอนด์", "lb", "ออนซ์", "oz", "เมตร", "meter", "cm", "มิลลิเมตร", "นิ้ว", "inch", "ฟุต", "ft", "cbm", "คิว", "ลิตร", "liter", "ปริมาตร", "volume", "น้ำหนัก", "weight", "ความยาว", "length", "ปนหน่วย", "หน่วยเดียวกัน", "ทั้งคอลัมน์"],
  },
  {
    id: "num-clean",
    name: "ล้างตัวเลขให้สะอาด",
    desc: "แปลงข้อความตัวเลขที่เลอะ ๆ ให้เป็นตัวเลขจริง — สัญลักษณ์สกุลเงิน ($ ฿ € £ ¥ / บาท / usd), ตัวคั่นหลักพันแบบ US (1,234.56) หรือ EU (1.234,56), วงเล็บติดลบสไตล์บัญชี (1,000) → -1000, เปอร์เซ็นต์, ช่องว่าง/NBSP → เป็นเลขล้วน · ต่างจาก Data Cleaner ที่ตัดแค่ comma แบบ US · อ่านไม่ออก = เว้นว่าง โชว์ให้เห็น ไม่เดามั่ว · default เติมคอลัมน์ใหม่ (ไม่ทับของเดิม) · ทุกแถวออกครบ",
    icon: "🧼",
    category: "clean",
    href: "/num-clean",
    status: "ready",
    keywords: ["ล้างตัวเลข", "ตัวเลข", "number", "normalize number", "สกุลเงิน", "currency", "เงิน", "ราคา", "price", "amount", "comma", "คอมมา", "1,234.56", "1.234,56", "EU", "US", "ยุโรป", "วงเล็บติดลบ", "accounting", "บัญชี", "เปอร์เซ็นต์", "percent", "%", "บาท", "ดอลลาร์", "usd", "eur", "nbsp", "ช่องว่าง", "clean number", "แปลงเป็นตัวเลข", "ทั้งคอลัมน์"],
  },
  {
    id: "num-format",
    name: "จัดรูปแบบตัวเลข",
    desc: "เอาตัวเลขดิบมาจัดรูปให้สวยสำหรับใบเสนอราคา/ใบแจ้งหนี้ — ใส่ตัวคั่นหลักพัน (1,234.56 US / 1.234,56 EU / 1 234.56), ทศนิยมคงที่, สัญลักษณ์เงินหน้า/ท้าย (฿ $ / บาท / kg), ติดลบสไตล์บัญชี (1,000.00), เครื่องหมาย +/- · ทิศตรงข้ามกับ ล้างตัวเลข (number → ข้อความจัดรูป) · ช่องไม่ใช่ตัวเลข = เว้นว่าง ไม่เดามั่ว · default เติมคอลัมน์ใหม่ (ไม่ทับของเดิม) · ทุกแถวออกครบ",
    icon: "💵",
    category: "excel",
    href: "/num-format",
    status: "ready",
    keywords: ["จัดรูปตัวเลข", "จัดรูปแบบตัวเลข", "format number", "number format", "ตัวคั่นหลักพัน", "thousands separator", "1,234.56", "1.234,56", "1 234.56", "ทศนิยม", "decimals", "สกุลเงิน", "currency", "เงิน", "ราคา", "price", "amount", "บาท", "฿", "$", "usd", "invoice", "ใบแจ้งหนี้", "ใบเสนอราคา", "quote", "ติดลบ", "วงเล็บ", "accounting", "บัญชี", "prefix", "suffix", "หน่วย", "kg", "plus sign", "เครื่องหมายบวก", "แสดงผล", "display"],
  },
  {
    id: "allocate",
  ...
  {
    id: "if-col",
    name: "ติดป้ายตามเงื่อนไข",
    desc: "ตั้งเงื่อนไขไล่จากบนลงล่าง → เจอข้อแรกที่ตรง = ใช้ป้ายนั้น → เติมคอลัมน์ป้ายให้ทุกแถว (IF/CASE) · เช่น note มีคำว่า \"ด่วน\" → \"เร่งด่วน\", status = \"hold\" → \"ระงับ\", น้ำหนัก > 100 → \"หนักพิเศษ\", CBM ว่าง → \"ต้องตรวจ\" · รองรับทั้งข้อความและตัวเลข (มีคำ/เท่ากับ/ขึ้นต้น/regex/ว่าง/มากกว่า/น้อยกว่า) · เงื่อนไขที่ยังไม่กรอกค่า = ถูกข้าม ไม่เดามั่ว · เติมคอลัมน์ใหม่ ไม่ทับของเดิม",
    icon: "🏷️",
    category: "clean",
    href: "/if-col",
    status: "ready",
  ...
  { id: "group-concat", name: "รวมค่าต่อกลุ่ม (GROUP_CONCAT)", desc: "ยุบหลายแถว key เดียวกันเป็นแถวเดียว แล้วต่อค่าหลายแถวในกลุ่มเป็นข้อความเดียว (เช่น 1 tracking หลายกล่อง → \"1, 2, 3\") · ต่างจาก /rollup (รวมยอดตัวเลข), /group (เหลือแค่ key+ยอด), /combine-col (ต่อคอลัมน์แนวนอน) · ตัดซ้ำ/เรียง/ข้ามว่างได้ · ทุกแถวเข้ากลุ่มไม่หาย", icon: "🧵", category: "excel", href: "/group-concat", status: "ready", keywords: ["group concat", "groupconcat", "group_concat", "textjoin", "concat", "ต่อค่า", "รวมค่า", "join", "aggregate string", "string agg", "1 tracking หลายกล่อง", "รวมต่อกลุ่ม", "เลขกล่อง", "tracking", "ตู้", "listagg", "รวมเป็นข้อความ"] },
  { id: "coalesce", name: "เลือกค่าแรกที่ไม่ว่าง (Coalesce)", desc: "เดินหลายคอลัมน์ตามลำดับความสำคัญ เจอค่าไม่ว่างช่องแรก = ใช้ค่านั้น → เติมเป็น 1 คอลัมน์ที่ครบ (เช่น tracking บางแถวอยู่คอลัมน์ \"tracking\" บางแถวอยู่ \"AWB\"/\"เลขพัสดุ\") · ต่างจาก /combine-col (ต่อทุกคอลัมน์เป็นข้อความ), /row-agg (รวมเลข), /fill (เติมช่องว่างแนวตั้ง) · ทุกแถวออกครบ ไม่เดามั่ว", icon: "🧯", category: "excel", href: "/coalesce", status: "ready", keywords: ["coalesce", "โคอะเลส", "ค่าแรกที่ไม่ว่าง", "first non-blank", "first non-null", "เลือกค่าแรก", "รวมคอลัมน์", "หลายแหล่ง", "fallback", "ค่าอยู่คนละคอลัมน์", "tracking", "awb", "เลขพัสดุ", "น้ำหนัก", "kg", "ตู้", "container", "เติมคอลัมน์"] },
  { id: "subtotal", name: "แทรกแถวยอดย่อย (Subtotal)", desc: "เก็บทุกแถวรายละเอียดครบ แล้ว \"แทรก\" แถวยอดรวมต่อกลุ่ม (เช่น รวม kg/CBM/กล่อง ต่อตู้) คั่นแต่ละกลุ่ม + แถวรวมทั้งหมดท้ายสุด — ได้รายงานปริ้นต์ได้เลย · ต่างจาก /group /rollup (ยุบทั้งกลุ่มเหลือแถวเดียว รายละเอียดหาย), /group-share (เติมคอลัมน์ %), /pivot (ตารางไขว้) · ไม่ทำข้อมูลหาย", icon: "📑", category: "excel", href: "/subtotal", status: "ready", keywords: ["subtotal", "ยอดย่อย", "แทรกแถวรวม", "แถวรวม", "data subtotal", "รวมต่อกลุ่ม", "subtotal row", "packing list", "รวมต่อตู้", "kg", "cbm", "กล่อง", "container", "ตู้", "รายงาน", "print", "ปริ้นต์", "excel subtotal"] },
  { id: "fill-blank", name: "เติมค่าให้ช่องว่าง", desc: "เติมเฉพาะช่องที่ว่างในคอลัมน์ที่เลือก ด้วยค่าคงที่ (เช่น 0, N/A) หรือค่าที่พบบ่อยสุดในคอลัมน์ (mode) · ต่างจาก /fill (เติมค่าที่มีจากแถวบน-ล่างแนวตั้ง), /coalesce (ค่าแรกที่ไม่ว่างข้ามคอลัมน์แนวนอน), /map (แทนค่าเดิมตามพจนานุกรม) · แตะเฉพาะช่องว่าง ไม่ทับค่าเดิม ไม่ทำแถวหาย", icon: "🪣", category: "excel", href: "/fill-blank", status: "ready", keywords: ["fill blank", "เติมช่องว่าง", "เติมค่าว่าง", "fill empty", "fill na", "เติม default", "ค่าเริ่มต้น", "mode", "ค่าที่พบบ่อย", "most common", "แทนช่องว่าง", "blank cell", "missing value", "impute", "เติมค่า", "น้ำหนัก", "สถานะ", "forwarder"] },
